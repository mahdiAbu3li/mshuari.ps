        ...
        <nav>
          <div class="nav flex-column position-fixed  mt-3 d-inline" id="nav-tab" role="tablist">
            <!-- <div class="row"> -->
              ...
              <a class="nav-item nav-link active d-inline " id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="false" >
              Home</a><br>
            <!-- </div> -->
          ...
          <div class="tab-pane fade" id="nav-available-trip" role="tabpanel" aria-labelledby="nav-contact-tab">
            ...
            <div class="row mb-5">
              <form class="form-inline my-2 my-lg-0">
                ...
                <div class="col">
                  <label class="form-control-lg" style="color: red;">Day</label>
                  <input class="form-control mr-sm-2" type="search" placeholder="Day" />
                </div>
                <div class="col">
                  <label class="form-control-lg" style="color: red;">Time</label>
                  <input class="form-control mr-sm-2" type="search" placeholder="Clock" />
                </div>
                <div class="col"></div>
                <div class="col pt-4">
                ...
                <div class="col">
                  <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                      <div class="col-md-4">
                        <img src="mahdi.jpg" class="card-img" alt="..." />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
